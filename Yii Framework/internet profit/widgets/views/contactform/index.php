...
<h1>Contact Us</h1>
<div class="contactMessageText"><span>If you have business inquries or
other questions, please fill out the following form to contact us. Thank
you. </span></div>
...
<?php echo CHtml::errorSummary($model); ?>
	...
	<?php echo CHtml::fileField('ContactForm[more]', null); ?>
